    ...
    return (
        <section className="py-24 bg-paper overflow-hidden">
            <motion.div
                ...
                // ÄNDERUNG 1: MEHR BREITE FÜR DIE GANZE SECTION
                // 'max-w-7xl' statt 'max-w-6xl'
                className="max-w-7xl mx-auto px-4"
            >
                {/* ÄNDERUNG 2: MINDESTHÖHE FÜR MEHR PLATZ NACH UNTEN */}
                <div className="bg-white border-2 border-[#EFE6DD] rounded-[3rem] p-8 md:p-16 shadow-lg min-h-[500px]">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <h2 className="font-serif text-4xl md:text-5xl italic text-coffee-dark mb-2">
                                Finde deinen
                            </h2>
                        ...
                        <div className="relative flex justify-center h-[350px] md:h-[550px]"> {/* Höhe auch leicht erhöht */}
